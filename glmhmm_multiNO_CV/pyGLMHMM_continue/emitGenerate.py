...
def _emit_generate(emit_w, trans_w, data, symb, options):
    ...
    feature_bins = 120 if options['use_AR'] == True else 0  ## features only from current time
    #feature_bins = 120  ## number of early/before time bins for calculating feartures used by current time 
